...
const Gatsby = () => (
  <svg
    ...
    viewBox="0 0 64 64"
    role="img"
    aria-labelledby="gatsby-icon-svg"
  >
    <title id="gatsby-icon-svg">Gatsby icon</title>
    <g transform="matrix(2.28571434655 0 0 2.28571434655 -.00000081293 -.00000085173)">
      <path
        ...
        fill="#fff"
      />
      <path d="m3 14.1c0 2.8 1.1 5.5 3.2 7.6s4.9 3.2 7.6 3.2z" fill="#fff" />
      <path
