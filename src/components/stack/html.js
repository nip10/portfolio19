...
const Html = () => (
  ...
  >
    <title id="html-icon-svg">Html icon</title>
    <path fill="#2d2d2d" d="M19.037 113.876l-10.005-112.215h109.936l-10.016 112.198-45.019 12.48z" />
    <path fill="#2d2d2d" d="M64 116.8l36.378-10.086 8.559-95.878h-44.937z" />
    <path
      fill="#EBEBEB"
